...
struct WorkspaceAgentLaunchTests {
    ...
    func agentGoalHandoffRendersLaunchCommandAndSecretBoundary() {
        ...
        #expect(rendered.contains("authsia workspace env list"))
        #expect(rendered.contains("authsia workspace env use <name>"))
        #expect(rendered.contains("authsia workspace env use Default"))
        #expect(rendered.contains("authsia workspace run --environment <name> -- <command>"))
