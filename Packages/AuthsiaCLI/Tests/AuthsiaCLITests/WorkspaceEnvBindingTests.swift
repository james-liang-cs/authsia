...
struct WorkspaceEnvBindingTests {
    ...
    func envAddListAndRemoveUpdateWorkspaceConfig() throws {
        ...
        #expect(listed.contains("| Reference"))
        #expect(listed.contains("HF_TOKEN"))
        #expect(listed.contains("authsia://password/HF_TOKEN/password?folder=Workspaces%2Fapi"))
    ...
    func envValidateReportsValidMissingAndUnverifiedBindings() throws {
        ...
        #expect(rendered.contains("valid"))
