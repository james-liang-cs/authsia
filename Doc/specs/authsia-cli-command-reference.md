...
| 5 | Codex rules | N/A | `authsia agent init --agent codex` | Creates or updates `.authsia/agent-rules.md` and `AGENTS.md` with compact MCP-first routing and an attributed outside-sandbox CLI fallback |
