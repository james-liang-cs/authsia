...
client files. Use MCP Manager **Protect connection** or
`authsia mcp wrap --write` to replace a scanned launch after confirmation.
It labels the exact config path, user-global/project scope,
